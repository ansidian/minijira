...
function App() {
  ...
  async function handleStatusChange(issueId, newStatus) {
    const updated = await api.patch(`/issues/${issueId}`, { status: newStatus });
  ...
  async function handleCreateIssue(data) {
    const newIssue = await api.post('/issues', { ...data, status: createStatus });
...
// Issue Detail Modal
function IssueDetailModal({ issue, users, currentUserId, onClose, onUpdate, onDelete, onStatusChange }) {
        ...
        <div className="modal-body">
          {editing ? (
            ...
            <>
              ...
              <div
                className={`issue-detail-description ${!issue.description ? 'empty' : ''}`}
                onClick={() => setEditing(true)}
                style={{ cursor: 'pointer' }}
              >
          ...
          <div className="issue-detail-meta">
            ...
            <div className="meta-item">
              ...
              <div className="meta-value">{formatDate(issue.created_at)}</div>
            </div>
          </div>
              ...
              <div key={comment.id} className="comment">
                <div className="comment-header">
                  <div
                    ...
                    style={{ background: comment.user_color || '#6b7280' }}
                  >
